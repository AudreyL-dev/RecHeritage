<?php
$pageTitle = "Mettre à jour ma Recette"; // Définir le titre dynamique
...
<body class="bg-[#f8f8f8] text-[#384d48] font-sans min-h-screen flex flex-col">
    <div class="container mx-auto p-4">
        ...
        <h1 class="text-3xl font-bold mb-6 text-center">
            Modifier "<?php echo htmlspecialchars($recipeById['title']); ?>"
        </h1>
            ...
            <form action="userRecipes.php" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title"
                        value="<?php echo htmlspecialchars($recipeById['title']); ?>"
                ...
                <div>
                    ...
                    <textarea id="recipe" name="recipe"
                        ...
                        required><?php echo htmlspecialchars($recipeById['recipe']); ?></textarea>
                </div>
